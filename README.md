...
>[!WARNING]
>The battery must be **plugged in** and **controller turned on**. Failure to do so will result in the CPU getting stuck in a bootloader loop when attempting to update.
